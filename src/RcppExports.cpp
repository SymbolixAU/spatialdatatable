...
RcppExport SEXP _spatialdatatable_rcpp_polyline_wkt(SEXP encodedStringsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::StringVector >::type encodedStrings(encodedStringsSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_polyline_wkt(encodedStrings));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_decode_pl
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_spatialdatatable_rcpp_polyline_wkt", (DL_FUNC) &_spatialdatatable_rcpp_polyline_wkt, 1},
